...
export default function GroupsPage() {
  return (
    <div className="page">
      ...
      <div className="tab-filter"><button className="tab active">Active</button><button className="tab">Done</button><button className="tab">Void</button></div>
      <main className="page-scroll content-area">
        {groups.map((group) => (
          <article className="group-card" key={group.title}>
            <div className="group-header">
              <div><div className="group-title">{group.title}</div><div className="group-members"><Users size={16} strokeWidth={2.5} /> {group.members}</div></div>
            ...
            <div className="progress-wrapper">
              ...
              <div className="progress-bar-bg"><div className="progress-bar-fill" style={{ width: `${group.progress}%`, backgroundColor: group.fill }} /></div>
            </div>
          </article>
        ))}
      </main>
